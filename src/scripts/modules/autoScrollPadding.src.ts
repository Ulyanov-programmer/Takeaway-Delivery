...
interface PermanentScrollPaddingItemArgs {
  selectedElement: string
  parent: string
  setInCssVariable?: string
}
export class PermanentScrollPaddingItem {
  public selectedElement: HTMLElement
  public parentElement: HTMLElement

  constructor(arg: PermanentScrollPaddingItemArgs) {
    arg.setInCssVariable
    this.selectedElement = document.querySelector(arg.selectedElement)
    this.parentElement = document.querySelector(arg.parent) ?? document.querySelector('html')

    if (arg.setInCssVariable) {
      document.documentElement.style.setProperty(arg.setInCssVariable, this.selectedElement.clientHeight + 'px')
    } else {
      this.parentElement.style.scrollPaddingTop = this.selectedElement.clientHeight + 'px'
    }
