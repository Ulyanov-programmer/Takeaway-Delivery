!function() {
  ...
  !function() {
    ...
    function r2(e3) {
      for (var t2, n3 = [], i2 = 0; i2 < e3.length; i2++)
        n3[i2] = "number" == typeof (t2 = e3[i2]) ? new CSSUnitValue(t2, "number") : t2;
      return n3;
    }
    var a2 = function() {
  ...
  function m(e2, t2) {
    if (!e2)
      return null;
    var n2 = "horizontal-tb" == getComputedStyle(e2).writingMode, i2 = e2.scrollTop;
    return ("horizontal" == t2 || "inline" == t2 && n2 || "block" == t2 && !n2) && (i2 = Math.abs(e2.scrollLeft)), i2;
  }
  function f(e2) {
    if (e2 instanceof N) {
      var t2 = e2.subject;
      t2 && "none" != getComputedStyle(t2).display ? h(e2, E(t2)) : h(e2, null);
    } else
      !function(e3) {
        var t3 = s.get(e3);
  ...
  var v = function() {
    function e2(e3) {
      s.set(this, { source: null, orientation: "block", anonymousSource: e3 ? e3.anonymousSource : null, anonymousTarget: e3 ? e3.anonymousTarget : null, subject: null, inset: e3 ? e3.inset : null, animations: [], scrollListener: null }), h(this, e3 && void 0 !== e3.source ? e3.source : document.scrollingElement), this.orientation = e3 && e3.orientation || "block", u(this);
    }
    return t(e2, [{ key: "source", get: function() {
      ...
      if (-1 === ["block", "inline", "horizontal", "vertical"].indexOf(e3))
      ...
      return "none" == t2.display ? "inactive" : e3 == document.scrollingElement || "visible" != t2.overflow && "clip" != t2.overflow ? "active" : "inactive";
      ...
      var t2 = this.orientation, n2 = m(e3, t2), i2 = function(e4, t3) {
        var n3 = "horizontal-tb" == getComputedStyle(e4).writingMode;
        return "block" === t3 ? t3 = n3 ? "vertical" : "horizontal" : "inline" === t3 && (t3 = n3 ? "horizontal" : "vertical"), "vertical" === t3 ? e4.scrollHeight - e4.clientHeight : "horizontal" === t3 ? e4.scrollWidth - e4.clientWidth : void 0;
      }(e3, t2);
  ...
  function g(e2, t2) {
    for (var n2 = e2.parentElement; null != n2; ) {
      if (t2(n2))
        return n2;
      n2 = n2.parentElement;
    }
  ...
  function y(e2, t2) {
    return "root" == e2 ? document.scrollingElement : E(t2);
  }
  function T(e2) {
  ...
  function b(e2) {
    return "static" != getComputedStyle(e2).position || S(e2);
  }
  function k(e2) {
  ...
  function w(e2, t2) {
    var n2 = s.get(e2);
    return "inactive" === e2.phase ? null : e2 instanceof N ? x(t2, e2.source, e2.subject, n2.orientation, n2.inset) : null;
  }
  function x(e2, t2, n2, i2, r2) {
    ...
    var c2 = getComputedStyle(t2), u2 = "horizontal-tb" == c2.writingMode, m2 = void 0, f2 = void 0, h2 = void 0;
    "horizontal" == i2 || "inline" == i2 && u2 || "block" == i2 && !u2 ? (m2 = n2.clientWidth, f2 = o2, ("rtl" == c2.direction || "vertical-rl" == c2.writingMode) && (f2 += t2.scrollWidth - t2.clientWidth), h2 = t2.clientWidth) : (m2 = n2.clientHeight, f2 = a2, h2 = t2.clientHeight);
    var d2 = function(e3, t3) {
      ...
      if (i3.forEach(function(e4) {
        e4.endsWith("%") ? r3.push(t3 / 100 * parseFloat(e4)) : e4.endsWith("px") ? r3.push(parseFloat(e4)) : "auto" === e4 && r3.push(0);
      }), r3.length > 2)
        throw TypeError("Invalid inset");
      return 1 == r3.length ? (n3.start = r3[0], n3.end = r3[0]) : 2 == r3.length && (n3.start = r3[0], n3.end = r3[1]), n3;
  ...
  function O(e2) {
    e2.readyPromise = new P(), requestAnimationFrame(function() {
      null !== e2.timeline.currentTime && Q(e2);
    });
  }
  function L() {
  ...
  function j(e2) {
    if (e2.finishedPromise && "pending" == e2.finishedPromise.state && "finished" == e2.proxy.playState) {
  ...
  function U(e2, t2) {
    ...
    return null == n2 ? null : n2 - t2 / e2.animation.playbackRate;
  }
  function H(e2, t2, n2) {
    if (e2.timeline) {
      ...
      if (i2 && null != e2.startTime && !e2.proxy.pending) {
        ...
        r2 > 0 && i2 >= a2 ? ((null === o2 || o2 < a2) && (o2 = a2), e2.holdTime = t2 ? i2 : o2) : r2 < 0 && i2 <= 0 ? ((null == o2 || o2 > 0) && (o2 = 0), e2.holdTime = t2 ? i2 : o2) : 0 != r2 && (t2 && null !== e2.holdTime && (e2.startTime = U(e2, e2.holdTime)), e2.holdTime = null);
      }
      K(e2), e2.previousCurrentTime = W(e2, e2.proxy.currentTime), "finished" == e2.proxy.playState ? (e2.finishedPromise || (e2.finishedPromise = new P()), "pending" == e2.finishedPromise.state && (n2 ? j(e2) : Promise.resolve().then(function() {
        j(e2);
      }))) : (e2.finishedPromise && "resolved" == e2.finishedPromise.state && (e2.finishedPromise = new P()), "paused" != e2.animation.playState && e2.animation.pause());
    }
  }
  function F(e2) {
    var t2 = function(e3) {
  ...
  function K(e2) {
    if (e2.timeline)
      if (null !== e2.startTime) {
        ...
        null !== e2.holdTime && q(e2, e2.holdTime);
  }
  function q(e2, t2) {
  ...
  function B(e2, t2) {
    if (e2.timeline) {
      var n2 = "paused" == e2.proxy.playState && e2.proxy.pending, i2 = false, r2 = null, a2 = W(e2, e2.proxy.currentTime);
      e2.resetCurrentTimeOnResume && (a2 = null, e2.resetCurrentTimeOnResume = false);
      var o2 = V(e2), l2 = F(e2);
      if (o2 > 0 && t2 && (null == a2 || a2 < 0 || a2 >= l2))
        r2 = 0;
      else if (o2 < 0 && t2 && (null == a2 || a2 <= 0 || a2 > l2)) {
        if (Infinity == l2)
          return void e2.animation.play();
        r2 = l2;
      } else
        0 == o2 && null == a2 && (r2 = 0);
      null != r2 && (e2.startTime = r2, e2.holdTime = null, D(e2)), p(e2.timeline, e2.animation, Y.bind(e2.proxy)), e2.holdTime && (e2.startTime = null), e2.pendingTask && (e2.pendingTask = null, i2 = true), (null !== e2.holdTime || null !== r2 || n2 || null !== e2.pendingPlaybackRate) && (e2.readyPromise && !i2 && (e2.readyPromise = null), K(e2), e2.readyPromise || O(e2), e2.pendingTask = "play", H(e2, false, false));
    }
  }
  function Y(e2) {
    var t2 = G.get(this);
    if (null != e2) {
      ...
      "running" != n2 && "finished" != n2 || (q(t2, (W(t2, e2) - W(t2, this.startTime)) * this.playbackRate), "finished" == n2 && 0 != V(t2) && (t2.holdTime = null), H(t2, false, false));
    } else
      "idle" != t2.animation.playState && t2.animation.cancel();
  }
  function Q(e2) {
    "pause" == e2.pendingTask ? function(e3) {
      var t2 = W(e3, e3.timeline.currentTime);
      null != e3.startTime && null == e3.holdTime && (e3.holdTime = (t2 - e3.startTime) * e3.animation.playbackRate), D(e3), e3.startTime = null, e3.readyPromise.resolve(e3.proxy), H(e3, false, false), K(e3), e3.pendingTask = null;
    }(e2) : "play" == e2.pendingTask && function(e3) {
      var t2 = W(e3, e3.timeline.currentTime);
      if (null != e3.holdTime)
        D(e3), 0 == e3.animation.playbackRate ? e3.startTime = t2 : (e3.startTime = t2 - e3.holdTime / e3.animation.playbackRate, e3.holdTime = null);
      else if (null !== e3.startTime && null !== e3.pendingPlaybackRate) {
        var n2 = (t2 - e3.startTime) * e3.animation.playbackRate;
        D(e3);
        var i2 = e3.animation.playbackRate;
        0 == i2 ? (e3.holdTime = null, e3.startTime = t2) : e3.startTime = t2 - n2 / i2;
      }
      e3.readyPromise && "pending" == e3.readyPromise.state && e3.readyPromise.resolve(e3.proxy), H(e3, false, false), K(e3), e3.pendingTask = null;
    }(e2);
  }
  var G = /* @__PURE__ */ new WeakMap(), X = function() {
    ...
    return n2.finish = function() {
      ...
      if (e3.timeline) {
        ...
        null === e3.startTime && null !== r2 && (e3.startTime = r2 - i2 / e3.animation.playbackRate), "pause" == e3.pendingTask && null !== e3.startTime && (e3.holdTime = null, e3.pendingTask = null, e3.readyPromise.resolve(this)), "play" == e3.pendingTask && null !== e3.startTime && (e3.pendingTask = null, e3.readyPromise.resolve(this)), H(e3, true, true);
      } else
        e3.animation.finish();
    }, n2.play = function() {
      var e3 = G.get(this);
      ...
      if (e3.timeline) {
        if ("paused" != this.playState) {
          ...
          if (null === e3.animation.currentTime)
            if (n3 >= 0)
              t2 = 0;
            else {
              if (Infinity == i2)
          ...
          null !== t2 && (e3.startTime = t2), "play" == e3.pendingTask ? e3.pendingTask = null : e3.readyPromise = null, e3.readyPromise || O(e3), e3.pendingTask = "pause";
        }
      } else
        e3.animation.pause();
    }, n2.reverse = function() {
      var e3 = G.get(this), t2 = V(e3), n3 = e3.resetCurrentTimeOnResume ? null : W(e3, this.currentTime), i2 = Infinity == F(e3), r2 = 0 != t2 && (t2 < 0 || n3 > 0 || !i2);
      if (!e3.timeline || !r2)
        return r2 && (e3.pendingPlaybackRate = -V(e3)), void e3.animation.reverse();
      if ("inactive" == e3.timeline.phase)
        ...
        if (!t2.readyPromise || "pending" != t2.readyPromise.state)
          switch (this.playState) {
            ...
            case "paused":
              ...
              break;
            case "finished":
              var n3 = W(t2, t2.timeline.currentTime), i2 = null !== n3 ? (n3 - t2.startTime) * t2.animation.playbackRate : null;
              t2.startTime = 0 == e3 ? n3 : null != n3 && null != i2 ? (n3 - i2) / e3 : null, D(t2), H(t2, false, false), K(t2);
              break;
            default:
              B(t2, false);
          }
      ...
      var e3 = G.get(this);
      e3.timeline ? ("idle" != this.playState && (function(e4) {
        e4.pendingTask && (e4.pendingTask = null, D(e4), e4.readyPromise.reject(L()), O(e4), e4.readyPromise.resolve(e4.proxy));
      }(e3), e3.finishedPromise && "pending" == e3.finishedPromise.state && e3.finishedPromise.reject(L()), e3.finishedPromise = new P(), e3.animation.cancel()), e3.startTime = null, e3.holdTime = null, d(e3.timeline, e3.animation)) : e3.animation.cancel();
      ...
      return e3.timeline ? (e3.effect || (e3.effect = function(e4) {
        var t2 = e4.animation.effect, n3 = t2.updateTiming, i2 = { apply: function(n4) {
          ...
          if (e4.timeline) {
            ...
            var r3 = F(e4);
            i3.duration = r3 ? CSS.percent(100 * (i3.iterations ? (r3 - i3.delay - i3.endDelay) / i3.iterations : 0) / r3) : CSS.percent(0), void 0 === e4.timeline.currentTime && (i3.localTime = null);
          }
          return i3;
          ...
          }(e4), c2 = true), (null === s2.duration || "auto" === s2.duration || c2) && e4.timeline && (c2 ? (s2.delay = o3 * a3, s2.endDelay = l2 * a3) : (s2.delay = 0, s2.endDelay = 0), s2.duration = s2.iterations ? ((s2.iterations ? a3 : 0) - s2.delay - s2.endDelay) / s2.iterations : 0, n3.apply(t2, [s2])), e4.normalizedTiming = s2, e4.specifiedTiming;
        } }, a2 = { apply: function(n4, i3, r3) {
          if (e4.timeline) {
            var a3 = r3[0];
            if (Infinity === a3.duration)
              throw TypeError("Effect duration cannot be Infinity when used with Scroll Timelines");
            if (Infinity === a3.iterations)
      ...
      if (t2 != e3) {
        ...
        if (l2 && d(r2.timeline, r2.animation), s2) {
          ...
          return c2 && (r2.readyPromise && "resolved" != r2.readyPromise.state || O(r2), r2.pendingTask = "paused" == n3 ? "pause" : "play"), null !== r2.startTime && (r2.holdTime = null), void H(r2, false, false);
        }
        if (r2.animation.timeline != e3)
          throw TypeError("Unsupported timeline: " + e3);
        if (d(r2.timeline, r2.animation), r2.timeline = null, l2)
          switch (null !== i2 && (r2.animation.currentTime = o2 * F(r2)), n3) {
            case "paused":
              r2.animation.pause();
              break;
            case "running":
      ...
      if (e3 = W(t2, e3), t2.timeline) {
        null == W(t2, t2.timeline.currentTime) && null != t2.startTime && (t2.holdTime = null, K(t2));
        var n3 = W(t2, this.currentTime);
        D(t2), t2.startTime = e3, t2.resetCurrentTimeOnResume = false, t2.holdTime = null !== t2.startTime && 0 != t2.animation.playbackRate ? null : n3, t2.pendingTask && (t2.pendingTask = null, t2.readyPromise.resolve(this)), H(t2, true, false), K(t2);
      } else
        t2.animation.startTime = e3;
    } }, { key: "currentTime", get: function() {
      var e3 = G.get(this);
      return e3.timeline ? _(e3, null != e3.holdTime ? e3.holdTime : z(e3)) : e3.animation.currentTime;
    }, set: function(e3) {
      var t2 = G.get(this);
      if (e3 = W(t2, e3), t2.timeline && null != e3) {
        var n3 = t2.timeline.phase;
        null !== t2.holdTime || null === t2.startTime || "inactive" == n3 || 0 == t2.animation.playbackRate ? t2.holdTime = e3 : t2.startTime = U(t2, e3), t2.resetCurrentTimeOnResume = false, "inactive" == n3 && (t2.startTime = null), t2.previousCurrentTime = null, "pause" == t2.pendingTask && (t2.holdTime = e3, D(t2), t2.startTime = null, t2.pendingTask = null, t2.readyPromise.resolve(this)), H(t2, true, false);
      } else
      ...
      if (t2.timeline) {
        ...
        t2.animation.playbackRate = e3, null !== n3 && (this.currentTime = n3);
      } else
      ...
      if (null === t2 && null === e3.startTime && null == e3.pendingTask)
        return "idle";
      if ("pause" == e3.pendingTask || null === e3.startTime && "play" != e3.pendingTask)
        return "paused";
      if (null != t2) {
      ...
      var e3 = G.get(this);
      return e3.timeline ? !!e3.readyPromise && "pending" == e3.readyPromise.state : e3.animation.pending;
    } }, { key: "id", get: function() {
  ...
  function $(e2, t2) {
    if (!e2)
      return null;
    var n2 = e2.split(" ");
    if (!C.includes(n2[0]) || 2 == n2.length && !n2[1].endsWith("%"))
    ...
    return t2.transpileStyleSheet = function(e3, t3, n2) {
      ...
      if (n2 || i2) {
        ...
        if (n2)
          for (var o2, s2 = l(this.extractMatches(e3.block.contents, ne.SCROLL_TIMELINE)); !(o2 = s2()).done; ) {
            ...
            1 == parts.length ? c2.name = parts[0] : 2 == parts.length && (ie.includes(parts[0]) ? (c2.axis = parts[0], c2.name = parts[1]) : (c2.axis = parts[1], c2.name = parts[0])), a2.push(c2);
          }
        if (i2)
      ...
      if (n2 || i2) {
        ...
        if (n2)
          for (var s2, c2 = l(this.extractMatches(e3.block.contents, ne.VIEW_TIMELINE)); !(s2 = c2()).done; ) {
            ...
            1 == parts.length ? u2.name = parts[0] : 2 == parts.length && (ie.includes(parts[0]) ? (u2.axis = parts[0], u2.name = parts[1]) : (u2.axis = parts[1], u2.name = parts[0])), o2.push(u2);
          }
        if (i2)
      ...
      var n2 = e3.block.contents, i2 = function(e4) {
        for (var t4 = 0, n3 = -1, i3 = [], r3 = 0; r3 < e4.length; r3++)
          "{" == e4[r3] ? t4++ : "}" == e4[r3] && t4--, 1 == t4 && "{" != e4[r3] && "}" != e4[r3] && -1 == n3 && (n3 = r3), 2 == t4 && "{" == e4[r3] && (i3.push({ start: n3, end: r3 }), n3 = -1);
        return i3;
      }(n2);
      if (0 == i2.length)
      ...
      return void 0 === n2 && (n2 = ","), t3.exec(e3)[1].trim().split(n2).map(function(e4) {
        return e4.trim();
      });
              ...
              return a3 ? (a3.subject && function(e4, t4) {
                ...
                if (r4 && r4.size) {
                  ...
                  e4.effect.getKeyframes().forEach(function(e5) {
                      ...
                      for (var a5, o4 = null, s2 = l(e6); !(a5 = s2()).done; ) {
                        ...
                        if (c2[0] == 100 * r5.offset) {
                          if ("from" == u2)
                            ...
                            var m2 = u2.split(" ");
                            o4 = 1 == m2.length ? parseFloat(m2[0]) : 100 * oe(m2[0], n4, t4.subject, i4, t4.inset, CSS.percent(parseFloat(m2[1])));
                          }
                          break;
                        }
                      }
                    ...
                    null !== o3 && o3 >= 0 && o3 <= 100 && (e5.offset = o3 / 100, a4.push(e5));
                  });
  ...
  if (!Reflect.defineProperty(Element.prototype, "animate", { value: function(e2, t2) {
    ...
    var i2 = function(e3, t3) {
      if (t3 in e3) {
        var n3 = e3[t3];
        return "number" != typeof n3 ? (delete e3[t3], n3) : null;
      }
    }, r2 = function(e3, t3) {
